...
public enum ReturnNo {
    ...
    ADDRESS_INVALID_INFO(602,"地址信息有误"),
    ADDRESS_EMPTY(603,"没有地址存在"),
    ADDRESS_NOTBELONGTO(604,"用户不拥有该地址"),
    ...
    CUSTOMER_QUANTITYNOTALLOW(616,"超过库存或限购数量"),
    CUSTOMER_CARTNOBELONGTO(617,"用户不拥有该购物车商品"),

    CUSTOMER_CANNOTBANNED(621,"该用户不能被禁用，可能处于逻辑删除状态"),
    CUSTOMER_CANNOTVAILD(622,"该用户不能被解禁，可能处于逻辑删除状态"),
    CUSTOMER_CANNOTDUBILEDELETE(623,"不能删除处于逻辑删除的用户"),
